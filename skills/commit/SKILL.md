---
name: commit
description: Create a conventional commit with intelligent message generation. Analyzes staged/unstaged changes, drafts a commit message following conventional commits format, and creates the commit. Use when the user asks to commit, save changes, or create a git commit.
...
4. Analyze the changes and draft a commit message:
   ...
   - Subject: imperative mood, under 72 chars, Chinese acceptable
