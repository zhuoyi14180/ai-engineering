---
name: review-pr
description: Perform a thorough code review of a pull request or the current branch's changes. Checks for bugs, security issues, code quality, test coverage, and adherence to project conventions.
